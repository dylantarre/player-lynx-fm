...
export function MusicPlayer() {
  ...
  const startAnimation = useCallback(() => {
    ...
    const animate = () => {
      ...
      // Update CSS variables for animation with extremely subtle scaling
      if (document.documentElement) {
        ...
        document.documentElement.style.setProperty('--morph-scale-1', `${1 + (lowFreq / 1024) * 0.5}`)
        document.documentElement.style.setProperty('--morph-scale-2', `${1 + (midFreq / 1024) * 0.5}`)
        document.documentElement.style.setProperty('--morph-scale-3', `${1 + (highFreq / 1024) * 0.5}`)
      }
            ...
            <div className="p-8">
              ...
              <div className="relative w-32 h-32 mx-auto mb-8">
                <div 
                  ...
                  style={{ transform: `scale(${1 + (lowFreq / 1024) * 0.5})` }}
                ></div>
                <div 
                  ...
                  style={{ transform: `scale(${1 + (midFreq / 1024) * 0.5})` }}
                ></div>
                <div className="absolute inset-4 rounded-full bg-gradient-to-br from-white/15 to-transparent backdrop-blur-sm flex items-center justify-center shadow-elevated">
                  <div 
                    ...
                    style={{ transform: `scale(${1 + (highFreq / 1024) * 0.5})` }}
                  ></div>
                </div>
              </div>
